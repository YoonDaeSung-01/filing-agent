...
def main() -> None:
    ...
    from filing_agent.eval.metrics import aggregate
    from filing_agent.eval.runner import run_goldset
    ...
    if args.out:
        ...
        with open(out_path, "w", encoding="utf-8") as f:
            json.dump({"scores": scores, "predictions": preds}, f, ensure_ascii=False, indent=2)
